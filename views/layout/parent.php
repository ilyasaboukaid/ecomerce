...
<body>
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li id="account"><a href="login"><i class="fa fa-user-circle" aria-hidden="true"></i></a></li>
    ...
    <footer class="section-p1">
        ...
        <div class="col install">
            ...
            <div class="row">
                <img src="/phpCrud/web/assets//phpCrud/web/assets/img/pay/app.jpg" alt="">
                <img src="/phpCrud/web/assets//phpCrud/web/assets/img/pay/play.jpg" alt="">
            </div>
            <p>Secured Payment Gateways</p>
            <img src="/phpCrud/web/assets//phpCrud/web/assets/img/pay/pay.png" alt="">
        </div>
